 ...
 * @package    Controller
 */
class xc_ContentComments extends ModuleComments
{
	/**
	 * Generate module
	 */
	protected function compile()
	{
		...
		$this->xc_Comments->addCommentsToTemplate($this->Template, $objConfig, 'tl_content', $this->id, $GLOBALS['TL_ADMIN_EMAIL']);
	}
}
